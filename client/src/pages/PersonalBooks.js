...
export default function PersonalBooks() {
  ...
  useEffect(() => {
    axios.get("http://localhost:5000/api/books/category/personal")
      .then(res => setBooks(res.data))
      .catch(err => console.error("Error fetching personal books:", err));
  }, []);

  return (
    <div>
      <h2 className="text-4xl font-bold mb-6">My Personal Books</h2>
